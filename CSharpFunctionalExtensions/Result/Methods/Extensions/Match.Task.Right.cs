...
public static partial class AsyncResultExtensionsLeftOperand
{
    ...
    ///     Returns the result of the given <paramref name="onSuccess"/> function if the calling Result is a success. Otherwise, it returns the result of the given <paramref name="onFailure"/> function.
    /// </summary>
    public static Task<K> Match<K, T>(this Result<T> result, Func<T, Task<K>> onSuccess, Func<IError, Task<K>> onFailure)
    {
        return result.IsSuccess
            ? onSuccess(result.Value)
            : onFailure(result.Error);
    ...
    ///     Returns the result of the given <paramref name="onSuccess"/> function if the calling Result is a success. Otherwise, it returns the result of the given <paramref name="onFailure"/> function.
    /// </summary>
    public static Task<T> Match<T>(this Result result, Func<Task<T>> onSuccess, Func<IError, Task<T>> onFailure)
    {
        return result.IsSuccess
            ? onSuccess()
            : onFailure(result.Error);
    ...
    ///     Invokes the given <paramref name="onSuccess"/> action if the calling Result is a success. Otherwise, it invokes the given <paramref name="onFailure"/> action.
    /// </summary>
    public static Task Match<T>(this Result<T> result, Func<T, Task> onSuccess, Func<IError, Task> onFailure)
    {
        return result.IsSuccess
            ? onSuccess(result.Value)
            : onFailure(result.Error);
    ...
    ///     Invokes the given <paramref name="onSuccess"/> action if the calling Result is a success. Otherwise, it invokes the given <paramref name="onFailure"/> action.
    /// </summary>
    public static Task Match(this Result result, Func<Task> onSuccess, Func<IError, Task> onFailure)
    {
        return result.IsSuccess
            ? onSuccess()
            : onFailure(result.Error);
