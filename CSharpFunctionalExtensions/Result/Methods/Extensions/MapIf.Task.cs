...
public static partial class ResultExtensions
{
    ...
    public static async Task<Result<T, E>> MapIf<T, E>(this Task<Result<T, E>> resultTask,
        bool condition,
        Func<T, Task<T>> func
    )
        where E : IError
    ...
    public static async Task<Result<T, E>> MapIf<T, E, TContext>(this Task<Result<T, E>> resultTask,
        bool condition,
        Func<T, TContext, Task<T>> func,
        TContext context
    )
