...
public static partial class AsyncResultExtensionsLeftOperand
{
    ...
    ///     Returns the result of the given <paramref name="onSuccess"/> function if the calling Result is a success. Otherwise, it returns the result of the given <paramref name="onFailure"/> function.
    /// </summary>
    public static async Task<K> Match<K, T>(this Task<Result<T>> resultTask, Func<T, Task<K>> onSuccess, Func<IError, Task<K>> onFailure)
    {
        return await (await resultTask.DefaultAwait())
            .Match(onSuccess, onFailure).DefaultAwait();
    }
    ...
    ///     Returns the result of the given <paramref name="onSuccess"/> function if the calling Result is a success. Otherwise, it returns the result of the given <paramref name="onFailure"/> function.
    /// </summary>
    public static async Task<T> Match<T>(this Task<Result> resultTask, Func<Task<T>> onSuccess, Func<IError, Task<T>> onFailure)
    {
        return await (await resultTask.DefaultAwait())
            .Match(onSuccess, onFailure).DefaultAwait();
    }
...
where E : IError
    ...
    ///     Invokes the given <paramref name="onSuccess"/> action if the calling Result is a success. Otherwise, it invokes the given <paramref name="onFailure"/> action.
    /// </summary>
    public static async Task Match<T>(this Task<Result<T>> resultTask, Func<T, Task> onSuccess, Func<IError, Task> onFailure)
    {
        await (await resultTask.DefaultAwait())
            .Match(onSuccess, onFailure).DefaultAwait();
    }
    ...
    ///     Invokes the given <paramref name="onSuccess"/> action if the calling Result is a success. Otherwise, it invokes the given <paramref name="onFailure"/> action.
    /// </summary>
    public static async Task Match(this Task<Result> resultTask, Func<Task> onSuccess, Func<IError, Task> onFailure)
    {
        await (await resultTask.DefaultAwait())
            .Match(onSuccess, onFailure).DefaultAwait();
    }
